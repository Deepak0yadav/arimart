        ...
        <div className="sm:hidden overflow-x-auto flex gap-4 py-2 -mx-4 px-4 scrollbar-hide">
          {categories.slice(0, 8).map((cat) => (
            ...
            >
              ...
              <p className="text-xs font-medium text-gray-800 text-center leading-tight">{cat.name}</p>
            </Link>
          ))}
        </div>
        ...
        <div className="hidden sm:grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {categories.map((cat) => (
            ...
            >
              ...
              <p className="text-sm font-medium text-gray-800 text-center leading-tight">{cat.name}</p>
            </Link>
          ))}
        </div>
      </div>
